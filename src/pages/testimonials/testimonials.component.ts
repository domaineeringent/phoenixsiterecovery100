...
export class TestimonialsComponent {
  ...
  authorityLogos = {
    seenOn: [
      ...
      { name: 'Inc. 5000', imageUrl: 'https://34b5c4bd622194aff81f417c1e9fe6dc.r2.cloudflarestorage.com/chimera_assets/31cad5cb4731c82ea5770f96ac0a9fd54d153e65bee104318612a4e27c811054.webp' },
      { name: 'Builder Magazine', imageUrl: 'https://34b5c4bd622194aff81f417c1e9fe6dc.r2.cloudflarestorage.com/chimera_assets/46b4223519875881d690caf602f03530db07d180fb56dbe6bed940e19c64a3d5.webp' }
    ],
    tech: [
      ...
      { name: 'Stripe', imageUrl: 'https://34b5c4bd622194aff81f417c1e9fe6dc.r2.cloudflarestorage.com/chimera_assets/d7e17d1a9ba2dfdeefa4d2ac6271502335ae3211b000cf3409478980b627d816.webp' }
    ]
  };
  ...
  beforeAfterGallery = [
    { 
      name: 'JD Roofing',
      before: { imageUrl: 'https://34b5c4bd622194aff81f417c1e9fe6dc.r2.cloudflarestorage.com/chimera_assets/ebe02a6196365299b85a6dd53837bb8620aeae0332e288c5a54a07a0c728125a.webp', stats: [{ value: '2-3', label: 'Leads/Week' }, { value: '12', label: 'Reviews' }] },
      after: { imageUrl: 'https://34b5c4bd622194aff81f417c1e9fe6dc.r2.cloudflarestorage.com/chimera_assets/6e6bd26ded5dbece2b7a5876d34d409a4e317ad0ff987114d6f5460d0d27ac87.webp', stats: [{ value: '15-20', label: 'Leads/Week' }, { value: '87', label: 'Reviews' }] }
    },
    { 
      name: 'Smith Electric',
  ...
  founder = {
    name: 'Alex Riley',
    title: 'Founder & CEO',
    imageUrl: 'https://34b5c4bd622194aff81f417c1e9fe6dc.r2.cloudflarestorage.com/chimera_assets/79d3730daeb94641da2d6144c8773a4500135724cf713ac4c28d095fa7a89f4e.webp',
  ...
  allTestimonials = signal<Testimonial[]>([
    { name: 'John Doe', company: 'JD Roofing', trade: 'Roofing', videoThumbnailUrl: 'https://34b5c4bd622194aff81f417c1e9fe6dc.r2.cloudflarestorage.com/chimera_assets/79dd8ccdcf7cc1e30fbc52494c90c1e19409cbec23c02227c432efe4055da89b.webp' },
    { name: 'Mike Smith', company: 'Smith Electric', trade: 'Electrical', videoThumbnailUrl: 'https://34b5c4bd622194aff81f417c1e9fe6dc.r2.cloudflarestorage.com/chimera_assets/e53d2eb1c79fec733cc19cf069ffdfc6520486ce49344b6e703a235c165969b6.webp' },
    { name: 'Carlos Garcia', company: 'Garcia Landscaping', trade: 'Landscaping', videoThumbnailUrl: 'https://34b5c4bd622194aff81f417c1e9fe6dc.r2.cloudflarestorage.com/chimera_assets/20b52f18c540d1ae63d798713370942dff6dd90ce3502844d63cae55fba9e731.webp' },
    { name: 'David Chen', company: 'Chen\'s Plumbing', trade: 'Plumbing', videoThumbnailUrl: 'https://34b5c4bd622194aff81f417c1e9fe6dc.r2.cloudflarestorage.com/chimera_assets/6c1a3b1fa24744625c6b9a25f1b1ae0ee416718348668c912a284124b5d3aed7.webp' },
    { name: 'Sarah Jenkins', company: 'Jenkins Remodeling', trade: 'Remodeling', videoThumbnailUrl: 'https://34b5c4bd622194aff81f417c1e9fe6dc.r2.cloudflarestorage.com/chimera_assets/6f45f8083cc1953fc29447f3a3616c789cfe1a386e79cefd23e0e2a24ed6a19b.webp' },
    { name: 'Tom Wilson', company: 'Wilson HVAC', trade: 'HVAC', videoThumbnailUrl: 'https://34b5c4bd622194aff81f417c1e9fe6dc.r2.cloudflarestorage.com/chimera_assets/1243d50daab1a0c2d6524855aaaf1f38f5d74488acb4bb473c5dd31daa76489f.webp' },
    { name: 'Maria Rodriguez', company: 'Rodriguez Painting', trade: 'Painting', videoThumbnailUrl: 'https://34b5c4bd622194aff81f417c1e9fe6dc.r2.cloudflarestorage.com/chimera_assets/31d1468ac77e63c5abf91290b42579683abc5d5492e1f6489cc1a800d3e0c65e.webp' },

...
export class BusinessPhoneComponent {
  ...
  data = {
    hero: {
      ...
      imageUrl: 'https://pub-7b0107d999fd4c8a8018460dffd25378.r2.dev/chimera_assets/6bf047229ed7b95d526e5fd8395a37f7ee29fd6c8232f89f28704caaf8dfe555.webp',
    },
    problem: {
      ...
      painPoints: [
        ...
        { imageUrl: 'https://pub-7b0107d999fd4c8a8018460dffd25378.r2.dev/chimera_assets/3fded0c5d954374be76d5979b7515e96dd9f1fa4d66112e29c3d48bb4952187f.webp', text: 'Looking like a one-man show.' },
        { imageUrl: 'https://pub-7b0107d999fd4c8a8018460dffd25378.r2.dev/chimera_assets/9c20999a76e7b592e29684c1fb1b5175ae7bdd5f6be4c47c19ae7044cb8e79dc.webp', text: 'No tracking of call performance.' },
      ]
    },
    solution: {
    ...
    featureDeepDive: {
      ...
      features: [
        { title: 'Call Recording', description: 'Automatically record all incoming and outgoing calls for quality assurance, training, and dispute resolution. Never again wonder "What did that customer say?"', imageUrl: 'https://pub-7b0107d999fd4c8a8018460dffd25378.r2.dev/chimera_assets/e101e128bcf20fabfecba79e9585148613e232f55d6e31e1e1c08d40c0778d6d.webp' },
        { title: 'Marketing Analytics', description: 'See exactly how many calls your marketing is generating. Track call volume, duration, and answer rates to understand your ROI.', imageUrl: 'https://pub-7b0107d999fd4c8a8018460dffd25378.r2.dev/chimera_assets/98dc5460e1d2829496c1b6b8a92c6fab8a3e038a33ba8d9035db632c97fb1552.webp' },

...
export class BusinessPhoneComponent {
  ...
  data = {
    hero: {
      ...
      imageUrl: 'chimera_assets/chimera_126_chimera_126.webp',
    },
    problem: {
      ...
      painPoints: [
        { imageUrl: 'chimera_assets/chimera_127_chimera_127.webp', text: 'Customers calling at all hours.' },
    ...
    featureDeepDive: {
      ...
      features: [
        { title: 'Call Recording', description: 'Automatically record all incoming and outgoing calls for quality assurance, training, and dispute resolution. Never again wonder "What did that customer say?"', imageUrl: 'chimera_assets/chimera_130_chimera_130.webp' },
